...
export const WeakElement = ({ data, keyProp }) => {
	...
	// console.log(data);
	return (
		<div className={completed ? 'weak__element weak__element_completed' : 'weak__element'}>
			<CustomeCheckbox id={data.id} completed={completed} setCompleted={setCompleted} objId={keyProp} />
			{data.value}
